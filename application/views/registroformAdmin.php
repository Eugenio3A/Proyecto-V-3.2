                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <select name="nombreCargo" class="form-control form-select form-select-lg" required>
                                    <option value=" " disabled selected> Seleccione una...</option>
                                    <?php
                                    foreach ($infocargousuario->result() as $row) {
                                        ?>
                                    <option value="<?php echo $row->nombreCargo?>"><?php echo $row->nombreCargo?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                        <input type="text" class="form-control" name="ciNit" placeholder="Escribe nombre de Usuario" required>
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="turno" placeholder="Escribe Apellido" required>
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="fotos" placeholder="Escribe Apellido" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="primerApellido" placeholder="Escribe Apellido" required>
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="segundoApellido" placeholder="Escribe Apellido" required>
                                    </div>
                                </div>
