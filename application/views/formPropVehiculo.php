...
<head>
    ...
    <title>Registrar Propietario de Vehículo</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">AGREGAR NUEVO PROPIETARIO</h1>
                            </div>

                            <?php echo form_open_multipart("vehiculo/agregarPropbd"); ?>

                            <form class="user">

<!-- Información del Propietario -->
<hr>
<h5 class="text-center">Información del Propietario</h5>

<div class="form-group row">
    <div class="col-sm-6 mb-3 mb-sm-0">
        <input type="text" class="form-control" name="ciNit" placeholder="Cédula o NIT" required>
    </div>
    <div class="col-sm-6">
        ...
        <input type="text" class="form-control" name="direccion" placeholder="Dirección del Propietario">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-8 mb-3 mb-sm-0">
                                        <button type="submit" class="btn btn-success btn-user btn-block">Agregar Propietario</button>
                                    </div>
                                    <div class="col-sm-4">
