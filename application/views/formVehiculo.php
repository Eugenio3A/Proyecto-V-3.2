                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <?php echo form_open_multipart("vehiculo/agregarbd"); ?>

                            <form class="user">
                                
<!-- Información del Vehículo -->
<hr>
<h5 class="text-center">Información del Vehículo</h5>

<div class="form-group row">
    <div class="col-sm-6 mb-3 mb-sm-0">
        <input type="text" class="form-control" name="numMovil" placeholder="Número de Móvil" required>
    </div>
    ...
    <select class="form-control" name="tipo" required>
        ...
        <option value="VagonetaParrilla">Vagoneta Parrilla</option>
        <option value="TaxiFamiliar">Taxi Familiar</option>
...
<div class="form-group row">
    <div class="col-sm-6">
        <input type="text" class="form-control" name="numChasis" placeholder="Número de Chasis" required>
    </div>
    <div class="col-sm-6 mb-3 mb-sm-0">
...
<div class="form-group row">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" name="placa" placeholder="Número de Placa" required>
    </div>
</div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-8 mb-3 mb-sm-0">
                                        <button type="submit" class="btn btn-success btn-user btn-block">Agregar Vehiculo</button>
                                    </div>
                                    <div class="col-sm-4">
