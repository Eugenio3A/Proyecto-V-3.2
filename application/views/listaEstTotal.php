...
<div class="header mt-4 mb-4 text-center">
    <h1 style="color: #2c3e50;">Lista de Solicitudes Asignadas</h1>
</div>
...
<div class="card-body mt-4">
    ...
    <tbody>
        ...
        ?>
        <tr class="estado-<?php echo strtolower($row['estado']); ?>">
        ...
        <?php
            ...
            echo "<tr><td colspan='10'>No hay solicitudes disponibles.</td></tr>";
        }
        ?>
    </tbody>
</table>
